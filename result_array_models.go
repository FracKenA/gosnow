...
type IncidentResultsArray struct {
	Result []struct {
...
type CmdbCiResultsArray struct {
	Result []struct {
		Asset struct {
			Link  string `json:"link,omitempty"`
			Value string `json:"value,omitempty"`
...
type CmdbCiServerResultsArray struct {
	Result []struct {
		Asset struct {
			Link  string `json:"link,omitempty"`
			Value string `json:"value,omitempty"`
...
type CmdbCiIpRouterResultsArray struct {
	Result []struct {
		Asset struct {
			Link  string `json:"link,omitempty"`
			Value string `json:"value,omitempty"`
...
type CmdbCiIpSwitchResultsArray struct {
	Result []struct {
		Asset struct {
			Link  string `json:"link,omitempty"`
			Value string `json:"value,omitempty"`
...
type CmdbCiFirewallNetworkResultsArray struct {
	Result []struct {
		Asset             string `json:"asset,omitempty"`
		AssetTag          string `json:"asset_tag,omitempty"`
		Assigned          string `json:"assigned,omitempty"`
...
type CmdbCiNetgearResultsArray struct {
	Result []struct {
		Asset struct {
			Link  string `json:"link,omitempty"`
			Value string `json:"value,omitempty"`
...
type CoreCompanyResultsArray struct {
	Result []struct {
		Active           string `json:"active,omitempty"`
...
type SysUserResultsArray struct {
	Result []struct {
		Active              string `json:"active,omitempty"`
